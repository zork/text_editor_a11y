...
Module['wasmTableSize'] = 35072;

Module['wasmMaxTableSize'] = 35072;
...
var real___GLOBAL__sub_I_mutex_cpp = asm["__GLOBAL__sub_I_mutex_cpp"]; asm["__GLOBAL__sub_I_mutex_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real___GLOBAL__sub_I_mutex_cpp.apply(null, arguments);
};
...
var __GLOBAL__sub_I_mutex_cpp = Module["__GLOBAL__sub_I_mutex_cpp"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__GLOBAL__sub_I_mutex_cpp"].apply(null, arguments) };
